...
<ConfigProvider :locale = zh_CN>
  ...
  >
    ...
    title="添加教师" @ok="handleOk2"  :maskClosable = false
    :closable = false  :footer="null" 
    >
    <a-form
    :model="formState2"
...
import {getTeacher , changeinfo , deleteTeacher,addTeacher} from '@/api/teacher.js'
...
export default ({
  ...
  setup() {
    ...
    const handleOk2 = e => {
      addTeacher(formState2.value).then( res =>{
        if(res.data.status === 0 ){
